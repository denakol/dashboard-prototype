...
const getUsersFailureHandler = (state: IUserState, action: PayloadAction<any, string, { arg: void, requestId: string, aborted: boolean, condition: boolean }, SerializedError>) => {
    return {
        ...state,
        usersStatus: {
            isPending: false,
